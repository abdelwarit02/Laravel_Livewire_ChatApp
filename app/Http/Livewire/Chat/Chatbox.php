...
class Chatbox extends Component
{
    ...
    public function  getListeners()
    {
        ...
        return [
            ...
            'loadConversation', 'pushMessage','broadcastMessageRead','resetComponent'
        ];
    }
...
$this->receiverInstance= null;
    ...
    public function loadConversation(Conversation $conversation, User $receiver)
    {
        ...
        // we use 'chat selected to make our chat box scrolled to the botom , we listen to it in the main.blade'
